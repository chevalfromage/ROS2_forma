...
#include "ex4/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ex4::msg::Sphere & ros_message,
...
{
  auto typed_message =
    static_cast<const ex4::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &ex4::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ex4, msg, Sphere)() {
  return &ex4::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
