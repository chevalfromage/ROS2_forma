...
#include "srv/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const srv::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &srv::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
